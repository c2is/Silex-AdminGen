        ...
        $(this).on('click', function(modalEvent)
        {
            ...
            '<div class="modal" id="confirmModal">' +
                ...
                '<div class="modal-footer">' +
                    '<button class="btn" data-dismiss="modal">#ButtonCancel#</button>' +
                    '<button class="btn btn-primary" data-dismiss="ok">#ButtonOk#</button>' +
                '</div>' +
            '</div>'
            ;
            ...
            modal = modal
                ...
                .replace('#ButtonCancel#',options.confirmButtonCancel)
                .replace('#ButtonOk#',options.confirmButtonOk);
